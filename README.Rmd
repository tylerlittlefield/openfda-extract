...
The data is relational as described [here](https://opendata.stackexchange.com/a/2187). Converting the data to tabular format may not be efficient and causes lots of duplication. If you want to run this, you need to have a database ready, some storage space, and patience. I have split the nested data into separate tables, in total:
...
I made this column so that tables can be joined (though this ID in some other form might already be available in the data, I just haven't figured it out). already)
